<script lang="ts">
	...
	import {
		startDatabaseMutationQuery,
		stopDatabaseMutationQuery,
		restartDatabaseMutationQuery
	} from '$lib/features/databases/mutations';
	...
	const startMutation = startDatabaseMutationQuery(projectId, resId, {
		onSuccess: () => {
	...
	const stopMutation = stopDatabaseMutationQuery(projectId, resId, {
		onSuccess: () => {
	...
	const restartMutation = restartDatabaseMutationQuery(projectId, resId, {
		onSuccess: () => {
