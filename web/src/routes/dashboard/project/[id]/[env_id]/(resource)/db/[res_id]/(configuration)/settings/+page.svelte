	...
	<div class="space-y-6">
		<Card>
			<CardHeader>
				...
				<p class="text-sm text-muted-foreground">Update your database name and description</p>
			</CardHeader>
		...
		<Card>
			<CardHeader>
				...
				<p class="text-sm text-muted-foreground">Manage environment variables for your database</p>
			</CardHeader>
			<CardContent>
