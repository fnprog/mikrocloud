<script lang="ts">
	...
	import { createRequestPasswordResetMutation } from '$lib/features/auth/mutations';
	...
	const requestPasswordResetMutation = createRequestPasswordResetMutation();
...
<div class="min-h-screen flex flex-col py-12 px-[85px]">
	<header class="flex items-center justify-between">
		...
		{#if allowRegistrations && setupStatusQuery.data?.is_setup}
