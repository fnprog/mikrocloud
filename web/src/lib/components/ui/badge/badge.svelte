<script lang="ts" module>
	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				default:
					"bg-badge text-badge-foreground [a&]:hover:bg-primary-hover border-transparent",
				secondary:
				...
				outline: "text-foreground [a&]:hover:bg-accent-hover [a&]:hover:text-accent-foreground",
			},
		},
		defaultVariants: {
			variant: "default",
